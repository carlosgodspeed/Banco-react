...
export default class App extends Component{
  ...
  constructor(props){
    ...
    this.state = {
      ...
      sexos: [
        ...
        {sexoNome: 'Prefiro não dizer', valor: 3},
      ],
      limite: 250,
      estudante: false,
    };
  ...
  render(){
    ...
    return(
      ...
      <Text style={styles.bancoLogo}>Banco nativeReact</Text>
      <Text style={styles.abaixo}>Abra sua Conta </Text>
      ...
      <View style={styles.areaFormulario}>
        ...
        <Text style={styles.textoNome}>RG/CPF</Text>
        <TextInput style={styles.input}
            
            placeholder="Digite seu Documento"
            underlineColorAndroid="transparent"
            onChangeText={(texto) => this.setState({Documento: texto})}
            keyboardType="numeric"
        />
        ...
        <View style={styles.limiteArea}>
              <Text style={styles.textoNome}>Defina Seu Limite:</Text>
